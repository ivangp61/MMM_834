...
SET
   ProcessStart = '2016-05-04 00:00:00'
   ,ProcessEnd = '2016-05-04 00:01:00'
   ,ExecutionStatus = 'COMPLETE'
WHERE
   ExecutionLogId in(4935347,
4935339,
4935329,
4935326,
4935324)
...
(CreationDate >= '2016-01-14'
      OR ModificationDate >= '2016-01-14')       AND
MemberRecId
IN
(652438)
;
...
--OUTPUT INSERTED.*
WHERE --(CreationDate >= '2016-04-05'     OR ModificationDate >= '2016-04-05')      AND
MemberRecId NOT
IN
(652438)
;
...
WHERE
(CreationDate >= '2016-01-14'
      OR ModificationDate >= '2016-01-14')
      AND MemberRecId IN
(652438)
;
...
--    OR ModificationDate >= '2016-04-05'
--    OR JobLoadDate = '2016-04-25')      AND
MemberRecId
NOT IN
(652438)
;
...
SET JobLoadDate = '2016-05-06'
WHERE (CreationDate >= '2016-01-14' OR ModificationDate >= '2016-01-14' )
      AND MemberRecId IN
                              (652438)
;
...
UPDATE dbo. MemberIndicator
SET JobLoadDate = '2016-04-01'
WHERE --(CreationDate >= '2016-04-05' OR ModificationDate >= '2016-04-05' OR JobLoadDate = '2016-04-25')     AND
...
WHERE AddrTypeMRefId = 4
      AND ( CreationDate >= '2016-01-14' OR ModificationDate >= '2016-01-14')
      AND MemberRecId IN
                              (652438)
;
...
SET JobLoadDate = '2016-04-01'
WHERE AddrTypeMRefId = 4
      --AND (CreationDate >= '2016-04-05' OR ModificationDate >= '2016-04-05' OR JobLoadDate = '2016-04-25')  
...
SET JobLoadDate = '2016-04-01'
WHERE ExternalTypeMRefId IN (5 , 9, 11)
      AND ( CreationDate >= '2016-04-05' OR ModificationDate >= '2016-04-05' OR JobLoadDate >= '2016-04-23' )
      AND MemberRecId NOT IN
                              (652438)
;
